...
class ApiClient {
    ...
    async createIndex(
        ...
        try {
            ...
            return {
                success: true,
                data: { success: true, message: 'Index created successfully' },
            };
        } catch (error) {
            return handleApiError(error);
        }
    ...
    async deleteIndex(
        ...
        try {
            ...
            return {
                success: true,
                data: { success: true, message: 'Index deleted successfully' },
            };
        } catch (error) {
            return handleApiError(error);
        }
    ...
    async deleteVectorById(
        ...
        try {
            ...
            return {
                success: true,
                data: { success: true, message: 'Vector deleted successfully' },
            };
        } catch (error) {
            return handleApiError(error);
        }
    ...
    async updateFilters(
        ...
        try {
            ...
            return {
                success: true,
                data: { success: true, message: 'Filters updated successfully' },
            };
        } catch (error) {
            return handleApiError(error);
        }
