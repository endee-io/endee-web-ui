                ...
                <div className="grid md:grid-cols-3 gap-4">
                    ...
                    <div className="bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-lg p-4">
                        ...
                        <p className="text-sm text-slate-600 dark:text-slate-300">
                            Define your vector dimensions and choose a distance metric (cosine,
                    ...
                    <div className="bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-lg p-4">
                        ...
                        <p className="text-sm text-slate-600 dark:text-slate-300">
                            Add your embedding vectors with optional metadata and filters for
                            advanced querying.
                        </p>
                    </div>
                    ...
                    <div className="bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-lg p-4">
                        ...
                        <p className="text-sm text-slate-600 dark:text-slate-300">
                            Find similar vectors using fast approximate nearest neighbor search with
                            optional filters.
                        </p>
                    </div>
                </div>
                ...
                >
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-slate-600 dark:text-slate-300 mt-1 mb-3">
                                Learn by doing with step-by-step interactive examples. Execute real
                                API calls and see results instantly.
                            </p>
                            <div className="text-sm text-slate-500 dark:text-slate-400">
                                Covers: Index creation • Vector insertion • Similarity search •
                                Filtered queries • Backup & restore
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-4 text-sm">
                    <div className="flex gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-slate-500 dark:text-slate-400">
                                Combine dense vectors with sparse vectors for better retrieval
                                accuracy.
                            </p>
                        </div>
                    </div>
                    <div className="flex gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-slate-500 dark:text-slate-400">
                                Filter results by metadata using $eq, $in, and $range operators.
                            </p>
                        </div>
                    </div>
                    <div className="flex gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-slate-500 dark:text-slate-400">
                                Choose from cosine similarity, Euclidean distance, or inner product.
                            </p>
                        </div>
                    </div>
                    <div className="flex gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-slate-500 dark:text-slate-400">
                                Balance between memory usage and accuracy with multiple options.
                            </p>
                        </div>
                    </div>
                    <div className="flex gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-slate-500 dark:text-slate-400">
                                Create backups of your indexes and restore them anytime.
                            </p>
                        </div>
                    </div>
                </div>
